...
JNI_LIBS_DIR="$ROOT_DIR/modules/crispy-native-core/android/src/main/jniLibs"
LEGACY_ASSETS_DIR="$ROOT_DIR/modules/crispy-native-core/android/src/main/assets/torrserver"
...
if [[ -d "$LEGACY_ASSETS_DIR" ]]; then
  echo "Removing legacy TorrServer assets dir: $LEGACY_ASSETS_DIR"
