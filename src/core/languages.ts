...
export const LANGUAGES: Language[] = [
    ...
    { code: 'bo', name: 'Tibetan', nativeName: 'བོད་ยིก' },
    ...
    { code: 'ii', name: 'Sichuan Yi', nativeName: 'ꆈꌠ꒿ Nuosu' },
    ...
    { code: 'mk', name: 'Macedonian', nativeName: 'маκεдонски јазик' },
    ...
    { code: 'pi', name: 'Pali', nativeName: 'पाळि' },
    ...
    { code: 'sm', name: 'Samoan', nativeName: 'gagana faʼa Samoa' },
